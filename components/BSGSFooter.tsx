                ...
                <BuilderContent modelName="footer">
                    {(data, loading) => (
                        <div className="flex flex-col lg:flex-row lg:justify-between gap-4 lg:gap-0 mx-auto px-4 py-8 font-content container mx-auto">
                            ...
                            <div className="flex flex-col items-center lg:order-first lg:justify-center lg:w-1/4 gap-4 bg-blue-normal rounded-2xl p-4 shadow-xl">
                            ...
                            <div className="flex flex-col items-center lg:order-last lg:justify-center lg:w-1/4 gap-4 bg-blue-normal rounded-2xl p-4 shadow-xl">
