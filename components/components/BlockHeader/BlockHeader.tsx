...
export default class BlockContent extends React.Component<HeaderProps> {
    static defaultProps = {
        title: "Page Title",
        image: ""
    }
    ...
    render() {
        return (
            ...
            text-white font-heading uppercase text-7xl text-center relative">
                ...
                <img className="absolute top-0 left-0 z-0 h-full w-full object-cover select-none filter brightness-[60%]"
                srcSet={`
